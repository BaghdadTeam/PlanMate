...
//
//    @Test
//    fun `should show task audit when valid UUID is entered for option 2`() {
//        // Given
//        val projectId = UUID.randomUUID()
//        val taskId = UUID.randomUUID()
//        every { readln() } returnsMany listOf("2", "0")
//        every { reader.readInput() } returns taskId.toString()
//
//        // When
//        auditUI(projectId)
//
//        // Then
//        verify(exactly = 1) { showAuditByTaskIdUI.execute(taskId) }
//        verify { viewer.logMessage("Enter Task UUID:") }
//    }
//
//    @Test
//    fun `should log error when invalid task UUID is entered`() {
...
//        val projectId = UUID.randomUUID()
//        every { readln() } returnsMany listOf("2", "0")
//        every { reader.readInput() } returns "not-a-uuid"
//
//        // When
//        auditUI(projectId)
//
//        // Then
//        verify { viewer.logError("Invalid UUID format. Please try again.") }
//        verify(exactly = 0) { showAuditByTaskIdUI.execute(any()) }
//    }
//
//    @Test
